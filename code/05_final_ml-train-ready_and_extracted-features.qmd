...
Growth Stage Description GDD Range (Approx.) Your Variables VE–V6 Early Vegetative \~100–600 gdd_sum_VE_V6 V6–VT Rapid Vegetative Growth \~600–1500 gdd_sum_V6_VT VT–R1 Flowering \~100 gdd_sum_VT_R1 R1–R3 Early Reproductive (Silking–Milk) \~400 gdd_sum_R1_R3 R3–R6 Grain Filling (Milk–Maturity) \~700 gdd_sum_R3_R6 After R6 Maturation to Black Layer \~100–150 gdd_sum_After_R6
...
```
```{r}
train_final <- write_csv(train_final, "../data/processed/train-final-soils-weather.csv") 
```
